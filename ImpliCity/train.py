...
#from config/train_test/ImpliCity-mono.yaml and train_test file
#ImpliCity is inherit from train_test, read both fiels and when conflict, use ImpliCity

# -------------------- shorthands --------------------
cfg_dataset = cfg['dataset']
#data/ImpliCity_demo/data
...
batch_size = cfg_training['batch_size'] #1
val_batch_size = cfg_training['val_batch_size'] #1

learning_rate = cfg_training['learning_rate'] #0.001 
model_selection_metric = cfg_training['model_selection_metric'] #iou??

print_every = cfg_training['print_every'] #1
visualize_every = cfg_training['visualize_every'] #1
validate_every = cfg_training['validate_every'] #100
checkpoint_every = cfg_training['checkpoint_every'] #50
backup_every = cfg_training['backup_every'] #2000
